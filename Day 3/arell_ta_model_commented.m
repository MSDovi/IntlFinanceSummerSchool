...
% Exercise: given the vector of output realizations y_vec, express
% consumption upon default as output net of output default costs.
% You can set y_bar to wc_par_asymm*y_mean
c_aut = ...
...
% Exercise: Evaluate the probability of next-period default and update the
% price of debt function accordingly. 
